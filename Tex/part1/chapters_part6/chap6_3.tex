...
\textit{Tuy nhiên, RAG chỉ là một trong nhiều cách để mở rộng khả năng của LLM. Chúng ta đã trao cho nó một "thư viện", nhưng liệu chúng ta có thể trao cho nó "mắt" để nhìn, "tai" để nghe, hay "tay" để hành động không? Những câu hỏi này sẽ là chủ đề của chương tiếp theo, nơi chúng ta sẽ khám phá các hệ thống và kiến trúc nâng cao khác như Mô hình Đa phương thức (Multimodal Models) và Hệ thống Tác tử (Agentic Systems), tiếp tục hành trình xây dựng các giải pháp AI toàn diện và mạnh mẽ hơn.}