...
\textit{Trong chương này, chúng ta đã mở rộng tầm nhìn vượt ra ngoài một LLM đơn lẻ để khám phá cách xây dựng các hệ thống AI thực sự toàn diện. Chúng ta đã học cách làm cho các mô hình trở nên tinh gọn và hiệu quả hơn thông qua tối ưu hóa, dạy chúng cách hiểu thế giới đa phương thức, và trao cho chúng khả năng hành động như một tác tử thông minh. Chúng ta cũng đã suy ngẫm về khả năng sâu xa của LLM trong việc xây dựng các mô hình thế giới nội tại.}
